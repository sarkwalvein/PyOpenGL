...
def display():
    ...
    glViewport (0, 0, s_width//2, s_height//2)
    calcCamera()
    draw_things()
    glViewport (s_width//2, 0, s_width//2, s_height//2)
    phi += math.pi/2
    calcCamera()
    draw_things()
    glViewport (s_width//2, s_height//2, s_width//2, s_height//2)
    theta += math.pi/2
    calcCamera()
    draw_things()
    phi = pp
    glViewport (0, s_height//2, s_width//2, s_height//2)
    calcCamera()
    draw_things()
    theta = tt
    glFlush ()
